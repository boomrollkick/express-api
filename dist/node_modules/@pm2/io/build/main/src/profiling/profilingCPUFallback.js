...
var ProfilingCPUFallback = function () {
    function ProfilingCPUFallback() {
        _classCallCheck(this, ProfilingCPUFallback);
    ...
    _createClass(ProfilingCPUFallback, [{
        key: "init",
        value: function init() {
        ...
        value: function getProfileInfo() {
            var cpu = this.profiler.stopProfiling(this.nsCpuProfiling);
            return JSON.stringify(cpu);
        }
    }]);

    return ProfilingCPUFallback;
}();

exports.default = ProfilingCPUFallback;
//# sourceMappingURL=profilingCPUFallback.js.map