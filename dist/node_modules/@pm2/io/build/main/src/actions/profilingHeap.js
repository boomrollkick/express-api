...
var ProfilingHeapAction = function () {
    function ProfilingHeapAction(actionFeature, config) {
        _classCallCheck(this, ProfilingHeapAction);
    ...
    _createClass(ProfilingHeapAction, [{
        key: "init",
        value: function init() {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.prev = 2;
                                _context.next = 5;
                                return this.profilings.heapProfiling.init(this.config.heap);
                            ...
                            case 8:
                                ...
                                debug("Failed to load heap profiler: " + _context.t0.message);
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.prev = 0;
                                _context2.next = 3;
                                return this.profilings.heapProfiling.stop();
        ...
        value: function exposeActions() {
            ...
            var startTime = null;
            this.actionFeature.action('km:heap:sampling:start', function (opts, reply) {
                        ...
                        while (1) {
                            switch (_context4.prev = _context4.next) {
                                case 0:
                                    ...
                                    _context4.next = 7;
                                    return this.profilings.heapProfiling.start();
            ...
            this.actionFeature.action('km:heap:sampling:stop', this.stopProfiling.bind(this, function (data) {
            ...
            // Heap dump
            // -------------------------------------
            this.actionFeature.action('km:heapdump', function (opts, reply) {
                        ...
                        while (1) {
                            switch (_context5.prev = _context5.next) {
                                case 0:
                                    ...
                                    _context5.prev = 3;
                                    _context5.next = 6;
                                    return this.profilings.heapProfiling.takeSnapshot();

                                case 6:
                                    data = _context5.sent;
                                    return _context5.abrupt("return", serviceManager_1.ServiceManager.get('transport').send('profilings', {
                                        data: data,
                                        at: startTime,
