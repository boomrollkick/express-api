...
var debug = require('debug')('interactor:reverse');
...
module.exports = function () {
  function ReverseInteractor(opts, ipm2, transport) {
    _classCallCheck(this, ReverseInteractor);
  ...
  _createClass(ReverseInteractor, [{
    key: 'start',
    ...
    key: '_onCustomAction',
    value: function _onCustomAction(data) {
      var _this = this;
      ...
      this.ipm2.msgProcess({
        ...
        if (err) {
          return _this.transport.send('trigger:action:failure', {
            success: false,
            err: err.message || err,
            id: data.process_id,
            action_name: data.action_name
        ...
        return _this.transport.send('trigger:action:success', {
          success: true,
          id: data.process_id,
          action_name: data.action_name
        });
    ...
    key: '_onPM2Action',
    value: function _onPM2Action(data) {
      var _this2 = this;
      ...
      var callback = function callback(err, res) {
        ...
        _this2.transport.send('trigger:pm2:result', {
          ret: { err: err, data: res },
          meta: {
            method_name: data.method_name,
            app_name: data.parameters.name,
            machine_name: _this2.opts.MACHINE_NAME,
  ...
  return ReverseInteractor;
}();
//# sourceMappingURL=ReverseInteractor.js.map