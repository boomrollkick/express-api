...
if (v7plus && !net._normalizeArgs) {
  ...
  net._normalizeArgs = function (args) {
    ...
    var arg0 = args[0];
    var options = {};
    if ((typeof arg0 === 'undefined' ? 'undefined' : _typeof(arg0)) === 'object' && arg0 !== null) {
      // (options[...][, cb])
      options = arg0;
    ...
    if (typeof cb !== 'function') return [options, null];else return [options, cb];
  };
...
if (childProcess.ChildProcess) {
  ...
  massWrap(childProcess, ['execFile', // exec is implemented in terms of execFile
  'fork', 'spawn'], function (original) {
    return function () {
      var result = original.apply(this, arguments);
...
function wrapPromise() {
  ...
  if (v6plus) {
    ...
    var PromiseFunctions = ['all', 'race', 'reject', 'resolve', 'accept', // Node.js <v7 only
