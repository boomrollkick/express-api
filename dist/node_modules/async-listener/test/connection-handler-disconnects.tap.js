...
test("another connection handler disconnects server", function (t) {
    ...
    server.on('listening', function () {
        ...
        client.on('close', function () {
            ...
            t.ok(!client._handle, 'close removed the client handle');

            server.close(function () {
                t.ok(!server._handle, 'Destroy removed the server handle');
            });
        });
    });
...
//# sourceMappingURL=connection-handler-disconnects.tap.js.map